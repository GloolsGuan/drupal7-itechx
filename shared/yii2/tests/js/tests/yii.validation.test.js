    ...
    describe('email validator', function () {
        ...
        describe('with basic configuration', function () {
            withData({
                ...
                'no angle brackets, name': ['Information selfinfo@oertliches.de', false],
                'no angle brackets, name, unicode in domain': ['Information selfinfo@örtliches.de', false],
                ...
                'angle brackets, name, unicode in domain': ['Information <selfinfo@örtliches.de>', false],
        ...
        describe('with allowed name and enabled IDN', function () {
            withData({
                ...
                'angle brackets, name, unicode in domain': ['Information <selfinfo@örtliches.de>', true],
                'angle brackets, name, unicode, local-part length is close to 64 characters': [
                    // 21 * 3 = 63
                    'Короткое имя <' + StringUtils.repeatString('бла', 21) + '@пример.com>',
                    false
