...
class View extends Component
{
    ...
    public function render($view, $params = [], $context = null)
    {
        ...
        //\Gtools\Debug::testLog(__METHOD__, [$view, $viewFile, $params], __LINE__);
    ...
    protected function findViewFile($view, $context = null)
    {
        ...
        //\Gtools\Debug::testLog(__METHOD__, $path, __LINE__);
        if(!in_array($this->defaultExtension, ['tpl', 'html', 'htm', 'php', 'phtml', 'tpl.php'])){
            throw new \Exception('System error: View extension name must be one of tpl,html,htm,php,phtml');
        }
        //if ($this->defaultExtension !== 'php' && !is_file($path)) {
        if(!is_file($path)){
            //$path = $file . '.php';
            throw new \Exception(sprintf('System error: The view file "%s" does not exists', $path));
        }
