<div class='page-wrapper clearfix'>
    ...
    <div class='content-wrapper box-wrapper clearfix'>
        <div class='regions-wrapper clearfix'>
            <div id='region-sidebar_top' class='region region-sidebar_top rc_lc_main clearfix'><?php include(THEME_LAS_DIR_TPL . '/regions/sidebar_top.tpl.php');?></div>
            <div id='region-main' class='region region-main rl_2c_main rl_2c_dl clearfix'><?php include( THEME_LAS_DIR_TPL . '/regions/main.tpl.php');?></div>
            <div id='region-sidebar_second' class='region region-sidebar_second rl_2c_side rl_2c_dl rl_2c_dr clearfix'><?php include( THEME_LAS_DIR_TPL . '/regions/sidebar_second.tpl.php');?></div>
        </div>
    </div>
